...
namespace ScriptingLua {
	...
	ScriptingLuaSystems::ScriptingLuaSystems(entt::registry& registry, Core::Scheduler& scheduler)
		: mRegistry{ registry }
	...
	ScriptingLuaSystems::~ScriptingLuaSystems() { mScheduler.unschedule(std::move(mTickHandle)); }
